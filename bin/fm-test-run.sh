...
family_for_basename() {
  case "$1" in
    ...
    fm-watch-cycle-hang.test.sh|fm-watch-triage.test.sh|fm-task-inbox.test.sh|\
    ...
    fm-spawn-dispatch-profile.test.sh|fm-spawn-treehouse-root.test.sh|fm-claude-trust.test.sh|fm-codex-trust.test.sh|\
...
tests/fm-product-decision.test.sh 40000
...
tests/fm-watch-cycle-hang.test.sh 7382
