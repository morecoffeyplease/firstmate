...
#     log in a pruned worktree). bin/fm-remote-job-reap-orphans.sh
...
# Fix 1 (see script header): pids of every process whose CURRENT WORKING
...
# them). Fix 1 (see script header) runs here, unconditionally on
